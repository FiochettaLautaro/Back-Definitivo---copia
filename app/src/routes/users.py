from flask import Blueprint, request, jsonify # blueprint es para crear rutas, endpoints/ requests y jsonify para devolver respuestas en formato JSON 
from bson.objectid import ObjectId # para manejar objects id de mongo
